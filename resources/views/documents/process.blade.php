...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (pdfContainer && pdfViewer) {
        ...
        // SOLUTION SIMPLIFIÉE : Laisser le module JavaScript gérer la désactivation
        // Le module pdf-overlay-unified-module.js gère déjà la désactivation automatique
        console.log('📱 Solution simplifiée - défilement propre activé');

        // SOLUTION SIMPLIFIÉE : Supprimer les conflits avec le module JavaScript
        console.log('📱 Solution simplifiée - défilement propre activé');

        // SOLUTION SIMPLIFIÉE : Laisser le module JavaScript gérer tous les événements
        console.log('📱 Gestion des événements déléguée au module JavaScript');
    }
    
    // ===== FONCTION BARRE DE DÉFILEMENT PERSONNALISÉE SUPPRIMÉE =====
    // La barre de défilement personnalisée n'est plus nécessaire
    function initCustomScrollbar() {
        console.log('📱 Barre de défilement personnalisée désactivée - défilement naturel activé');
        return;
    }
});
</script>

<!-- Barre de défilement personnalisée supprimée - défilement naturel activé -->
@endsection
